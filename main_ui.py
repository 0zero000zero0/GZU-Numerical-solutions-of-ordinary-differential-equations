...
class Ui_BasicForm(object):
    def setupUi(self, BasicForm):
        ...
        self.options.setGeometry(QtCore.QRect(9, 9, 913, 251))
        ...
        self.input_4.setReadOnly(False)
        self.input_4.setPlaceholderText("请输入步长")
        ...
        self.input.setText("")
        self.input.setPlaceholderText("如果是多步法，请使用空格隔开")
        ...
        self.frame_2.setGeometry(QtCore.QRect(10, 400, 911, 241))
        self.frame_2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_2.setObjectName("frame_2")
        self.result = QtWidgets.QTableWidget(parent=BasicForm)
        self.result.setGeometry(QtCore.QRect(10, 270, 911, 121))
        ...
        self.x = None
        self.y = None
        self.please_input = QtWidgets.QMessageBox(BasicForm)
    ...
    def retranslateUi(self, BasicForm):
        ...
        self.choose_algorithm_2.setText(_translate("BasicForm", "起始点(集)"))
